...
const User  = require("../../Models/diagnosis");
 ...
 * @description API Will be /api/v1/a/diagnosis/pagin
        ...
        for (let index = 0; index < array1.length; index++) {
            ...
            newUser.save(function (err, user) {
                if (err) {
                    ...
                    res.status(200).json({
                        message: langFunction('en', 'newdiagnosis'),
                        "data": user,
                    });
                }
            })
                ...
                if (data) {
                    ...
                    data.save(function (err) {
                        if (err) {
                            ...
                            res.status(200).json({
                                message: langFunction('en', 'updateDiagnosis'),
                                "name": data,
                            });
                        }
                    });
 ...
 * @description API Will be /api/v1/a/diagnosis/:id
