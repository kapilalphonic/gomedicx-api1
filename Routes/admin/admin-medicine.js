...
const User  = require("../../Models/medicines");
 ...
 * @description API Will be /api/v1/a/medicine/pagin
...
/**
 * @function  recommended_Insert
 * @description API Will be /api/v1/a/diagnosis/insert
 ...
 router.post('/insert', async (req, res) => {
    try {
        ...
        for (let index = 0; index < array1.length; index++) {
            ...
            newUser.decription = userData.description;
            ...
            newUser.save(function (err, user) {
                if (err) {
                    ...
                    res.status(200).json({
                        message: langFunction('en', 'newmedicine'),
                        "data": user,
                    });
                }
            })
 ...
 * @description API Will be /api/v1/a/medicine/update/:id
                ...
                if (data) {
                    ...
                    data.save(function (err) {
                        if (err) {
                            ...
                            res.status(200).json({
                                message: langFunction('en', 'updatemedicine'),
                                "name": data,
                            });
                        }
                    });
 ...
 * @description API Will be /api/v1/a/medicine/:id
