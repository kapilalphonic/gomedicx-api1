 ...
 * @description API Will be /api/v1/a/recommended/pagin
 ...
 * @description API Will be /api/v1/a/recommended/insert
        ...
        for (let index = 0; index < array1.length; index++) {
            ...
            newUser.save(function (err, user) {
                if (err) {
                    ...
                    res.status(200).json({
                        message: langFunction('en', 'newrecommended'),
                        "data": user,
                    });
                }
            })
                ...
                if (data) {
                    ...
                    data.save(function (err) {
                        if (err) {
                            ...
                            res.status(200).json({
                                message: langFunction('en', 'updaterecommended'),
                                "name": data,
                            });
                        }
                    });
